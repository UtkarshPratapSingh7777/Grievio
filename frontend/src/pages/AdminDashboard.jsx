    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-red-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
          ...
          <p className="text-white/70 mb-2">Department: {adminData?.dept || 'N/A'}</p>
          <p className="text-white/70 mb-6">Location: {adminData?.location?.city || 'N/A'}</p>
          
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white/5 p-6 rounded-xl border border-white/10">
              <h3 className="text-xl font-semibold text-white mb-2">Total Complaints</h3>
              <p className="text-4xl font-bold text-purple-400">0</p>
            </div>
            <div className="bg-white/5 p-6 rounded-xl border border-white/10">
              <h3 className="text-xl font-semibold text-white mb-2">Pending</h3>
            ...
            <div className="bg-white/5 p-6 rounded-xl border border-white/10">
              <h3 className="text-xl font-semibold text-white mb-2">Resolved</h3>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-xl font-bold text-white mb-4">Staff Members</h3>
